...
class PressArticleGenerator extends BaseGenerator {
  const PressArticleGenerator({
    super.key,
  });

  @override
  _PressArticleGeneratorState createState() => _PressArticleGeneratorState();
}

class _PressArticleGeneratorState
    extends BaseGeneratorState<PressArticleGenerator>
  ...
  String selectedArticleType = 'News';
  String selectedStyle = 'Informative';
  String selectedLength = 'Medium (500-800 words)';
  String? _errorMessage; // Added for displaying errors

  // Color scheme
  final Color primaryColor =
      const Color.fromARGB(255, 1, 29, 42); // Deep blue/teal
  final Color secondaryColor =
      Color.fromARGB(255, 0, 0, 0); // Black as secondary
  final Color accentColor =
      Color(0xFF8B5CF6); // Purple accent (keep consistent)
  ...
  final List<String> articleStyles = [
    'Informative',
    'Critical',
    'Narrative',
    'Analytical',
  ...
  final List<String> articleLengths = [
    'Short (300-500 words)',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_isTrialActive)
                        ...
                        Text(
                          // Keep the original message or make it generic
    ...
    return ResponsiveWidget(
      ...
      mobile: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "Press Article", // Keep original title
            style: TextStyle(
              color: textColor,
              fontWeight: FontWeight.bold,
              fontSize: 18,
                          ...
                          child: isEditing
                              ? TextField(
                                  ...
                                  decoration: InputDecoration.collapsed(
                                    hintText: 'Generated article text...',
                                    hintStyle: TextStyle(
                        ...
                        if (generatedContent.isNotEmpty && !isGenerating)
                          Container(
                            ...
                            child: Wrap(
                              ...
                              runSpacing: 6,
                              children: [
                                _buildBadge(selectedArticleType,
                                    FontAwesomeIcons.newspaper, primaryColor),
                                _buildBadge(
                                    selectedStyle,
                                    ...
                                    secondaryColor != Colors.black
                                        ...
                                        : primaryColor.withOpacity(
                                            0.7)), // Use different color if secondary is black
                                _buildBadge(
                                    selectedLength,
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 12),
                                Text(
                                  // Show selected type in header
                                  selectedArticleType,
                                  style: TextStyle(
                                    fontSize: 18, // Larger for desktop header
                                    fontWeight: FontWeight.bold,
                                    color: textColor,
                                    letterSpacing: 0.3,
                                  ),
                            ...
                            child: isEditing
                                ? TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          'The generated article will appear here...',
                                      hintStyle:
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(height: 24),
                                                      Text(
                                                        'Your press article will appear here',
                                                        style: TextStyle(
                                                          fontSize: 18,
                                                          color:
                                                              Colors.grey[400],
                                                      ...
                                                      SizedBox(height: 12),
                                                      Text(
                                                        'Fill in the form and click "Generate Article" to create your press article',
                                                        style: TextStyle(
                                                          fontSize: 14,
                                                          color:
                                                              Colors.grey[400],
  ...
  Widget buildForm() {
    return Column(
      ...
      children: [
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                accentColor
                    .withOpacity(0.6) // Use accent color slightly lighter
              ],
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Create Professional Press Articles',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18,
                        color: Colors.white,
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Well-structured and informative articles for your audience',
                      style: TextStyle(
        ...
        // Article Type & Format (Keep original)
        buildSectionHeader('Article Type & Format', FontAwesomeIcons.newspaper),
        SizedBox(height: 20),
          ...
          children: [
            ...
            Expanded(
              child: buildDropdown(
                ...
                icon: Icons.style_outlined, // Changed icon
              ),
            ),
          ],
        ),
        ...
        buildDropdown(
          ...
          items: articleLengths,
          onChanged: (value) {
            setState(() {
              selectedLength = value!;
            });
          },
          icon: Icons.format_size_outlined, // Changed icon
        ),
        SizedBox(height: 24),

        // Key Information (Keep original)
        buildSectionHeader(
            'Key Information', FontAwesomeIcons.circleInfo), // Changed icon
        SizedBox(height: 20),

        buildTextField(
          controller: headlineController,
          label: 'Article Headline',
          hint: 'An attention-grabbing and informative headline',
          icon: Icons.title,
          required: true,
        ),
        SizedBox(height: 16),
        ...
        buildTextField(
          ...
          label: 'Main Topic',
          hint: 'Describe the main topic of the article',
          icon: Icons.topic_outlined, // Changed icon
          required: true,
        ),
        SizedBox(height: 16),
        ...
        buildTextField(
          ...
          hint: 'Essential information to include',
        ...
        buildTextField(
          ...
          hint: 'Who is this article aimed at?',
          icon: Icons.people_outline, // Changed icon
        ),
        SizedBox(height: 16),

        buildTextField(
          controller: quotesController,
          label: 'Quotes or Sources (optional)',
          hint: 'Add expert quotes or sources to include',
          icon: Icons.format_quote_outlined, // Changed icon
          maxLines: 3,
        ),
        SizedBox(height: 28),

        // Error message (Keep original, ensure errorColor is used)
        ...
        // *** START QUOTA DISPLAY LOGIC (Adapted from Other Generators) ***
  ...
  // Helper for Quota Warning (Similar to AdsGenerator/BlogPost)
  ...
  void generateContent() async {
    ...
    if (headlineController.text.trim().isEmpty ||
        ...
        keyPointsController.text.trim().isEmpty) {
      setState(() {
        _errorMessage = 'Please fill in all required fields (*)';
        isGenerating = false; // Stop generation
      });
      showErrorSnackBar(
          'Please fill in all required fields (*)'); // Also show snackbar
      return;
    }
  ...
  String _buildAIPrompt() {
    final String headline = headlineController.text;
    ...
    final String quotes = quotesController.text;

    return '''
    Generate a professional $selectedArticleType press article adhering to journalistic standards.

    **Specifications:**
    *   **Headline:** ${headline}
    *   **Main Topic:** ${topic}
    *   **Key Points to Cover:** ${keyPoints}
    *   **Target Audience:** ${audience.isNotEmpty ? audience : "General public / Relevant media outlets"}
    *   **Quotes/Sources (Optional):** ${quotes.isNotEmpty ? quotes : "Integrate relevant quotes or factual data if appropriate for the topic."}
    *   **Writing Style:** ${selectedStyle} (e.g., objective, analytical, narrative)
    *   **Article Length:** ${selectedLength} (Adjust detail and scope accordingly)

    **Structure and Formatting:**
    *   Begin with a strong lead paragraph summarizing the core news or angle.
    *   Develop the key points logically in the body paragraphs, providing context and evidence.
    *   Incorporate quotes naturally, if provided or relevant.
    *   Conclude effectively, summarizing the key takeaway or indicating next steps/future outlook.
    *   Use clear, concise language suitable for press distribution.
    *   Format using Markdown with appropriate headings (H2, H3) if needed for longer articles, paragraphs, and bullet points for lists if applicable.

    **Output:**
    *   Provide only the final press article content. Do not include introductory text or explanations.
    ''';
  }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        action: SnackBarAction(
          label: 'OK', // Changed label for consistency
