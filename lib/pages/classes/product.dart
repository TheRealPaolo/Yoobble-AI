...
class ProductDescriptionGenerator extends BaseGenerator {
  const ProductDescriptionGenerator({
    super.key,
  });

  @override
  _ProductDescriptionGeneratorState createState() =>
      _ProductDescriptionGeneratorState();
}

class _ProductDescriptionGeneratorState
    extends BaseGeneratorState<ProductDescriptionGenerator>
    with SingleTickerProviderStateMixin {
  final TextEditingController productNameController = TextEditingController();
  final TextEditingController productTypeController = TextEditingController();
  final TextEditingController keyFeaturesController = TextEditingController();
  final TextEditingController targetAudienceController =
      TextEditingController();
  final TextEditingController brandValuesController = TextEditingController();
  final TextEditingController pricingInfoController = TextEditingController();

  // TabController for mobile view
  late TabController _tabController;

  String selectedDescriptionLength = 'Medium (150-250 words)';
  String selectedDescriptionStyle = 'Persuasive';
  String selectedPlatform = 'E-commerce Website';
  String selectedTone = 'Professional';
  String? _errorMessage;

  final List<String> descriptionLengths = [
    'Short (50-100 words)',
  ...
  final List<String> descriptionStyles = [
    'Persuasive',
    'Informative',
    'Technical',
    'Storytelling',
  ...
  final Color primaryColor =
      const Color.fromARGB(255, 0, 8, 49); // Main color (Deep Blue)
  final Color secondaryColor =
      Color.fromARGB(255, 50, 12, 121); // Purple accent (Used for Pro)
  final Color accentColor = Color(0xFF00ACC1); // Cyan accent
  ...
  void dispose() {
    ...
    brandValuesController.dispose();
    pricingInfoController.dispose();
    ...
    return ResponsiveWidget(
      ...
      mobile: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            "Product Description", // Keep original title
            style: TextStyle(
              color: textColor,
              fontWeight: FontWeight.bold,
              fontSize: 18, // Use consistent mobile title size
            ),
          ),
          centerTitle: false,
        ...
        body: SafeArea(
          child: TabBarView(
            ...
            children: [
              // Tab 1: Form/Options
              // Use SingleChildScrollView and Card structure for mobile form
              ...
              // Use SingleChildScrollView and Card structure for mobile results
              SingleChildScrollView(
                padding: EdgeInsets.all(16.0),
                child: Card(
                  elevation: 0,
                        ...
                        if (generatedContent.isNotEmpty && !isGenerating)
                          Container(
                            ...
                            child: Wrap(
                              ...
                              runSpacing: 8,
                              children: [
                                _buildBadge(selectedPlatform,
                                    FontAwesomeIcons.globe, primaryColor),
                                _buildBadge(
    ...
    return Column(
      children: [
        ...
        buildDropdown(
          ...
          value: selectedDescriptionStyle,
          items: descriptionStyles,
          onChanged: (value) {
            setState(() {
              selectedDescriptionStyle = value!;
            });
          },
        ...
        buildDropdown(
          label: 'Length',
          value: selectedDescriptionLength,
          items: descriptionLengths,
          onChanged: (value) {
            setState(() {
              selectedDescriptionLength = value!;
            });
          },
    ...
    return Column(
      children: [
        ...
        buildTextField(
          ...
          hint: 'e.g., Skincare, Electronics, Apparel',
        ...
        buildTextField(
          ...
          hint: 'Waterproof, Bluetooth 5.0, Organic Cotton',
        ...
        buildTextField(
          ...
          hint: 'e.g., Tech enthusiasts, Busy moms, Athletes',
          icon: FontAwesomeIcons.userGroup,
          required: true,
        ),
        SizedBox(height: 16),
        buildTextField(
          controller: brandValuesController,
          label: 'Brand Values (optional)',
          hint: 'e.g., Eco-friendly, Innovative, Luxurious',
        ...
        buildTextField(
          ...
          label: 'Pricing/Value (optional)',
          hint: 'e.g., Affordable luxury, Premium price',
  ...
  void generateContent() async {
    ...
    if (productNameController.text.trim().isEmpty ||
        ...
        keyFeaturesController.text.trim().isEmpty ||
  ...
  String _buildAIPrompt() {
    ...
    final String keyFeatures = keyFeaturesController.text;
    final String targetAudience = targetAudienceController.text;
    final String brandValues = brandValuesController.text;
    final String pricingInfo = pricingInfoController.text;

    // Extract the word count range from length selection
    String wordCountRange = "150-250"; // Default to medium
    if (selectedDescriptionLength.contains("Short")) {
      wordCountRange = "50-100";
    } else if (selectedDescriptionLength.contains("Long")) {
      wordCountRange = "300-500";
    } else if (selectedDescriptionLength.contains("Detailed")) {
      wordCountRange = "500+"; // Adjusted range for Detailed
    }

    // Construct a detailed and structured prompt
    return '''
Act as an expert product description writer. Create a compelling product description with the following specifications:
...
${brandValues.isNotEmpty ? "*   Brand Values/Personality: $brandValues" : ""}
${pricingInfo.isNotEmpty ? "*   Pricing/Value Proposition: $pricingInfo" : ""}

**Description Parameters:**
*   Target Platform: $selectedPlatform
*   Writing Style: $selectedDescriptionStyle (e.g., focus on benefits, features, storytelling)
*   Tone of Voice: $selectedTone
*   Desired Length: Approximately $wordCountRange words

**Instructions:**
1.  Craft a captivating product description tailored for the specified **Target Platform**.
2.  Highlight the **Key Features** and translate them into tangible **benefits** for the **Target Audience**.
3.  Adopt the specified **Writing Style** and **Tone of Voice** consistently. Reflect **Brand Values** if provided.
4.  Start with a strong hook to grab attention immediately.
5.  Use persuasive language and storytelling elements (if appropriate for the style) to engage the reader.
6.  Address potential customer pain points and how the product solves them.
7.  If **Pricing/Value Proposition** is provided, incorporate it strategically.
8.  Ensure the description flows well and is easy to read.
9.  Conclude with a subtle call to action or reinforce the main benefit.
10. Adhere to the approximate **Desired Length**.

**Output:**
Provide only the final product description. Do not include any introductory phrases, explanations, or labels.
''';
  }
  ...
  Widget buildForm() {
    return Column(
      ...
      children: [
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                ...
                secondaryColor.withOpacity(0.8) // Using secondary color here
              ],
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Product Description', // Consistent title
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                    ...
                    SizedBox(height: 4),
                    Text(
                      'Create descriptions that convert', // Consistent tagline
                      style: TextStyle(
        ...
        buildSectionHeader('Description Style & Format',
            FontAwesomeIcons.sliders), // Consistent icon
        SizedBox(height: 20),
        // Use the responsive helpers here based on context
        // Since buildForm is called within both mobile/desktop layouts,
        // we determine which dropdown layout to use based on screen size.
        ResponsiveWidget(
        ...
        buildSectionHeader(
            'Product Details', FontAwesomeIcons.boxOpen), // Consistent icon
        SizedBox(height: 20),
        // Use the responsive helpers here
        ResponsiveWidget(
